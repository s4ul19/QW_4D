...
\begin{document}
\maketitle
\janote{Faltan resultados sobre el promedio temporal de la distribución de probabilidad (la que tiene una distribución límite)}\janote{Lo importante aquí era que aparecían dos cosas: (1) localización en el sito inicial que es característica de la moneda de Grover (explicación en un paper de Aharonov, creo, Saul sabe), (2) patrones de localización siempre que la geometría es integrable, y ausencia de los patrones cuando la geometría es caótica}
