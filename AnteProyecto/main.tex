...
En primer lugar, la implementación del operador de evolución unitaria dado por la ecuación~\eqref{eq:U} y el análisis del sistema se llevarán a cabo empleando el paquete especializado \textit{QuantumWalks}~\cite{quantumwalks}\janote{Corregí el bibitem, parece que no modificaste nada de como te lo dio gemini} desarrollado en Wolfram Mathematica, del cual el autor del presente trabajo es contribuyente. 
