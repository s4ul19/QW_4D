...
\begin{itemize}
    ...
    En primer lugar, se implementará numéricamente el operador de evolución unitaria dado por la ecuación~\eqref{eq:U}\janote{para cuál operador shift? El que lo mueve en cruz o equis?}.
    ...
    La estructura del operador de desplazamiento $S$ se establecerá mediante un conjunto de reglas de movimiento condicionadas por el estado de la moneda. Por su parte, la dinámica interna del caminante se gobernará mediante el operador $C = \mathbb{I} \otimes \mathcal{C}$, donde $\mathbb{I}_P$ representa el operador identidad en el espacio de posición y $\mathcal{C}$ es un operador unitario que actúa exclusivamente sobre el espacio de la moneda de cuatro dimensiones. \janote{Aquí creo que te toca decir que vas a utilizar un paquete que ya está hecho y no que vos lo vas a hacer porque sería mentira}
    ...
    El análisis posterior se enfocará exclusivamente en las fases de estos valores, las cuales corresponden a las cuasienergías del sistema y servirán como base para el estudio estadístico.\janote{Falta decir que vas a hacer el unfolding del espectro. Sería bueno que gemini te explique cuál es el método que usa la función y lo expliqués aquí. No hace falta que lo expliqués ahorita en el esqueeleto, pero sí una vez tengás el visto bueno de Carlos para escribir}
