...
\begin{center}
    ...
    Carné: 202107506 \\[1cm]
    Julio 2026 \cpnote{Actualiza la fecha a cuando pienses entregarlo es decir Agosto o septiembre}\\[1cm]
...
}\snnote{Gracias por eso, no tenía idea.}, mientras que la conjetura de Bohigas, Giannoni y Schmit (BGS) establece que, si el análogo clásico es caótico, las propiedades estadísticas del espectro seguirán de manera universal las predicciones de RMT~\cite{bohigas1984characterization}.
