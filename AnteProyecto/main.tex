...
\janote{Tiene mi VoBo}
\cpnote{Tiene mi VoBo}
...
Esto facilita el estudio de fenómenos como el transporte coherente~\cite{mulken2011continuous,Xu_2008}, las transiciones de fase topológicas~\cite{kitagawa2010exploring} y las dinámicas en redes estructuradas~\cite{Dhamapurkar_2026,portugal2018quantum}.
Además, estos modelos pueden ser implementados directamente en diversas plataformas experimentales, como circuitos fotónicos~\cite{peruzzo2010quantum,lorz2019photonic} o redes ópticas~\cite{karski2009quantum,Schreiber_2010}\cpnote{cita, por favor cuando pongas las citas, trata de que esté el link y que se pueda hacer click, para verificar que si citaste bien}\snnote{Añadidas citas.}\cpnote{Es facil poner el link en la bibliografia. Porfa ponselo. Es decir, que pueda uno irse al documento citado con un click}\snnote{Links añadidos}. 
Esta viabilidad experimental representa una ventaja, ya que permite investigar fenómenos cuánticos evadiendo las limitaciones tecnológicas, como la decohrencia, que actualmente impiden la construcción de computadoras cuánticas universales a gran escala~\cite{portugal2018quantum}. 
