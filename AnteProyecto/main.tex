...
Para investigar cómo se manifiestan estas propiedades en el régimen cuántico, las caminatas cuánticas ofrecen un marco de estudio ventajoso. En estos modelos discretos es posible imponer las geometrías de los billares clásicos directamente como condiciones de frontera. Esto resulta ideal ya que las caminatas cuánticas nos permiten variar de manera independiente tanto estas condiciones de frontera como el operador de moneda, ofreciendo así un excelente escenario para estudiar a detalle la dinámica del sistema.
