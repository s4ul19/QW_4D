...
Esto facilita el estudio de fenómenos como el transporte coherente\cpnote{Para cada uno de los fenomenos, tienes que dar una o dos citas}, las transiciones de fase topológicas y las dinámicas en redes estructuradas~\cite{portugal2018quantum}.
Además, estos modelos pueden ser implementados directamente en diversas plataformas experimentales, como circuitos fotónicos \cpnote{cita} o redes ópticas\cpnote{cita, por favor cuando pongas las citas, trata de que esté el link y que se pueda hacer click, para verificar que si citaste bien}. 
