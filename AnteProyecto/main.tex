...
Para estudiar este fenómeno de forma aislada, los sistemas de billar resultan ideales, ya que permiten transicionar de una dinámica integrable a una caótica alterando únicamente la geometría de sus fronteras (como ocurre al pasar de un rectángulo a un billar de Sinaí). Incorporar estas geometrías en el espacio bidimensional de una caminata cuántica es sumamente ventajoso: al tratarse de un modelo discreto, otorga un control matemático riguroso sobre el operador de evolución, lo que facilita aislar la influencia exclusiva de la frontera sobre el comportamiento espectral del sistema.
