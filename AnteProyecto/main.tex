...
\janote{la cita \cite{grover1996fastquantummechanicalalgorithm} debe ir al final del enunciado}.
...
En la literatura reciente, se ha estudiado un modelo de caminata cuántica bidimensional que emplea dos qubits como estado de moneda~\cite{alonso-lobo2025simplest}\janote{esto es incorrecto, hablemos}, concluyendo que existe una correspondencia entre las condiciones de frontera y la dinámica del sistema.
