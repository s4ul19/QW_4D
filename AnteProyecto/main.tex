...
Las caminatas cuánticas poseen una relevancia científica importante, ya que dan lugar a la implementación de nuevos algoritmos cuánticos~\cite{shenvi2003quantum} y, al constituir un modelo de computación universal~\cite{childs2009universal,lovett2010universal}, permiten simular sistemas físicos complejos\janote{Enunciado largo, partir en 2 o 3. Una separación natural es terminar con ``..relevancia científica importante'' y el resto se puede ajustar para ser uno o dos ennciados}. 
Esto facilita el estudio de fenómenos como el transporte coherente, las transiciones de fase topológicas y las dinámicas en redes estructuradas~\cite{portugal2018quantum}. Además, \sout{debido a su estructura matemática,}\janote{no me queda claro que esto sea cierto y creo que no aporta} estos modelos pueden ser implementados directamente en diversas plataformas experimentales, como circuitos fotónicos o redes ópticas, sin requerir el desarrollo de computadoras cuánticas universales\janote{por qué es relevante que no necesiten de computadoras cuánticas? no entiendo el punto de este último pedazo de la oración}~\cite{portugal2018quantum,lorz2019photonic}.
De este modo\janote{de cuál modo? 'De este modo' no me parece buen conector, porque creo que lo anterior y este enunciado son dos cosas separadas}, proporcionan una entorno controlable~\cite{kendon2003decoherence} para explorar la dinámica de la información.
