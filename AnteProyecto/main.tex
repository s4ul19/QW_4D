...
\begin{itemize}
    ...
    El análisis posterior se enfocará exclusivamente en las fases de estos valores, las cuales corresponden a las cuasienergías del sistema y servirán como base para el estudio estadístico.
