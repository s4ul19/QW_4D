...
En este trabajo se considerará un dominio espacial bidimensional y una dimensión de su espacio de moneda de cuatro\cpnote{Redaccion rara}. La dinámica depende de cómo se formule el operador unitario $\mathcal{U}$ responsable de la evolución\cpnote{frase vacia}.
...
este trabajo propone investigar si la dinámica de un caminante con una moneda en 4D exhibe rasgos de caoticidad o integrabilidad y si las condiciones de frontera son suficientes para establecer dicha distinción\cpnote{Esta frase es super importante porque estas diciendo lo que quieres hacer en el trabajo, sin embargo se me hace innecesariamente complicada. Quizá partela en dos o simplificala}.
