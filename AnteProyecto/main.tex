...
\begin{itemize}
    ...
    Adicionalmente, para detectar correlaciones de largo alcance, se computará el factor de forma espectral (SFF) aplicando los promedios estadísticos adecuados para visualizar la posible formación de un agujero de correlaciones, una rampa y su eventual saturación.
