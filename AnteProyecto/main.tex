...
Esto facilita el estudio de fenómenos como el transporte coherente~\cite{mulken2011continuous,Xu_2008}\cpnote{Para cada uno de los fenomenos, tienes que dar una o dos citas}\snnote{He añadido citas}, las transiciones de fase topológicas~\cite{kitagawa2010exploring} y las dinámicas en redes estructuradas~\cite{Dhamapurkar_2026,portugal2018quantum}.
Además, estos modelos pueden ser implementados directamente en diversas plataformas experimentales, como circuitos fotónicos~\cite{peruzzo2010quantum,lorz2019photonic}\cpnote{cita} o redes ópticas~\cite{karski2009quantum,Schreiber_2010}\cpnote{cita, por favor cuando pongas las citas, trata de que esté el link y que se pueda hacer click, para verificar que si citaste bien}\snnote{Añadidas citas.}. 
